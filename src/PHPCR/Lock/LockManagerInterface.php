...
interface LockManagerInterface {
     ...
     * @return void
     * @throws \PHPCR\Lock\LockException if the specified lock token is already held by another Session and the implementation does not support simultaneous ownership of open-scoped locks.
     ...
     * @throws \PHPCR\Lock\LockException if this node is not mix:lockable or this node is already locked or isDeep is true and a descendant node of this node already holds a lock.
     ...
     * @return void
     * @throws \PHPCR\Lock\LockException if this node does not currently hold a lock or holds a lock for which this Session does not have the correct lock token

...
final class OnParentVersionAction
{
     ...
     * @api
     */
    public const ACTIONNAME_COPY = 'COPY';
     ...
     * @api
     */
    public const ACTIONNAME_VERSION = 'VERSION';
     ...
     * @api
     */
    public const ACTIONNAME_INITIALIZE = 'INITIALIZE';
     ...
     * @api
     */
    public const ACTIONNAME_COMPUTE = 'COMPUTE';
     ...
     * @api
     */
    public const ACTIONNAME_IGNORE = 'IGNORE';
